...
function initCanvas() {
  ...
  document.querySelector('.soc-facebook').href = "https://www.facebook.com/dialog/share_open_graph?app_id=469906346520500&display=popup&action_properties="+ encodeURIComponent(location.href) +"&redirect_uri=" + encodeURIComponent(location.href);
